  ...
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
        ...
        />
        <path
          d="M16 8h6l-1 5H16M11 17.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM22 17.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z"
          stroke="#22c55e"
          strokeWidth="1.75"
          strokeLinecap="round"
        />
...
const STEPS = [
  {
    ...
    body: "Submit your business details. Our team reviews every application within 1–2 business days.",
  },
  {
    num: "02",
    title: "Get approved & browse",
    body: "Once approved, unlock wholesale pricing across 200+ brands and thousands of SKUs.",
  },
  {
    num: "03",
    title: "Place your order",
    body: "Use our catalogue or bulk order tool to build your order. Pay via Paystack or bank transfer.",
  },
  {
    num: "04",
    title: "Track & reorder",
    body: "Monitor every shipment via DHL tracking. Repeat past orders in seconds from your dashboard.",
  },
];
    ...
    <div className="flex flex-col flex-1 overflow-hidden">
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 80% 50% at 50% -10%, rgba(34,197,94,0.13) 0%, transparent 70%)",
          }}
        />
        <div
          className="absolute inset-0 pointer-events-none"
        ...
        <div className="relative z-10 px-5 max-w-4xl mx-auto animate-fadeUp">
          ...
          >
            OuterSkinX connects verified retailers and distributors with
            top-tier skincare brands at competitive wholesale rates. Apply once,
            buy forever.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-10">
            ...
            <Link href="/catalogue" className="btn-ghost px-8 py-3.5 text-base">
              Browse Catalogue
            </Link>
          </div>
        ...
        <div className="relative z-10 w-full mt-16 px-5 md:px-8 max-w-6xl mx-auto">
          ...
          >
            <Image
              src="https://outerskinx.com/wp-content/uploads/2024/10/osx21-scaled.webp"
      ...
      >
        ...
        <div className="flex animate-marquee whitespace-nowrap">
          {[...BRANDS_MARQUEE, ...BRANDS_MARQUEE].map((b, i) => (
            ...
            >
              {b}
              <span style={{ color: "var(--brand-green)", fontSize: "0.5rem" }}>
                ◆
              </span>
            </span>
          ))}
      ...
      <section className="max-w-6xl mx-auto px-5 md:px-8 py-28">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <Image
              src="/how.jpg"
              alt="Buyer placing a wholesale order"
              fill
              className="object-cover"
            />
            {/* <ImgPlaceholder
          ...
          <div>
            ...
            <p
              className="text-sm mb-10 max-w-xs"
              style={{
                color: "var(--foreground-muted)",
                fontWeight: 300,
                lineHeight: 1.7,
            ...
            >
              From application to delivery — the OuterSkinX wholesale process is
        ...
        <div className="max-w-6xl mx-auto px-5 md:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            <div>
              ...
              >
                Every tool on this platform exists to help you buy smarter,
                faster, and at better prices than anywhere else.
              </p>
            </div>
            <div
              style={{
            ...
            >
              <Image
                src="https://images.unsplash.com/photo-1741655262435-4890ab9918fa?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fEFmcmljYW4lMjBXYXJlaG91c2UlMkMlMjBjdXJhdGVkJTIwcHJvZHVjdCUyMGRpc3BsYXklMkMlMjBvciUyMHRlYW0lMjBwaG90by4lMjBMYW5kc2NhcGUuJTIwUmVjb21tZW5kZWQlM0ElMjAxMjAwJUMzJTk3NjgwcHgufGVufDB8fDB8fHww"
                alt="OuterSkinX platform features"
                fill
              ...
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow =
                    "0 0 0 1px var(--border-accent), 0 12px 40px rgba(0,0,0,0.4)";
                }}
                onMouseLeave={(e) => {
      ...
      <section className="max-w-6xl mx-auto px-5 md:px-8 py-28">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="lg:sticky lg:top-28">
            ...
            >
              Every approved buyer is assigned a tier. As your order volume
              grows, your pricing improves automatically.
            </p>
            <div
              style={{
                height: 360,
            ...
            >
              <Image
                src="https://images.unsplash.com/photo-1748002369513-af0f999d9f1e?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt="Store owner reviewing wholesale pricing"
                fill
                className="object-cover rounded-2xl"
              />
              {/* <ImgPlaceholder
                ...
                <div className="flex items-start justify-between gap-4 mb-4">
                  <div>
                    <span
                      ...
                      style={{ background: tier.colorBg, color: tier.color }}
                    >
                      {tier.name}
                    </span>
                    <p
                  ...
                  <Link
                    ...
                    className={
                      tier.featured
                        ? "btn-primary text-sm py-2.5 px-5 shrink-0"
                        : "btn-ghost text-sm py-2.5 px-5 shrink-0"
                    }
      ...
      >
        <div className="max-w-6xl mx-auto px-5 md:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                {[
                  {
                    quote:
                      "OuterSkinX cut our restocking time in half. The bulk order tool is unmatched.",
                    name: "Adaeze O.",
                    role: "Retailer, Lagos",
                  },
                  {
                    quote:
                      "Pricing is genuinely competitive. Finally a platform built for serious distributors.",
                    name: "Emeka K.",
                    role: "Distributor, Abuja",
                  },
                  {
                    quote:
                      "From application to first delivery in under 4 days. Truly impressed.",
                    name: "Fatima I.",
                    role: "Retailer, Kano",
                  },
                ].map((t, i) => (
                  ...
                  >
                    <Image
                      src={`https://images.unsplash.com/photo-1614023342667-6f060e9d1e04?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8YWZyaWNhbiUyMG1hbnxlbnwwfHwwfHx8MA%3D%3D-${i + 1}`}
                      alt={t.name}
                      width={44}
                      height={44}
            ...
            >
              <Image
                src="https://images.unsplash.com/photo-1560181275-a65519fd0ec1?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8SGFwcHklMjBzdG9yZSUyMG93bmVyJTIwb3IlMjBidXllciUyMHdpdGglMjBwcm9kdWN0cy4lMjBUYWxsJTIwcG9ydHJhaXQlMjBjcm9wLiUyMFJlY29tbWVuZGVkJTNBJTIwODAwJUMzJTk3MTEyMHB4LnxlbnwwfHwwfHx8MA%3D%3D"
                alt="Happy retail buyer"
                fill
        ...
        >
          <div className="grid lg:grid-cols-2 min-h-[400px]">
            ...
            <div style={{ position: "relative", minHeight: 320 }}>
              <Image
                src="https://images.unsplash.com/photo-1627384114006-f7b66c22baf1?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8UHJlbWl1bSUyMHByb2R1Y3QlMjBzcHJlYWQlMjBvciUyMGFzcGlyYXRpb25hbCUyMHNraW5jYXJlJTIwbGlmZXN0eWxlJTIwaW1hZ2UuJTIwRnVsbCUyMGJsZWVkLiUyMFJlY29tbWVuZGVkJTNBJTIwOTYwJUMzJTk3ODAwcHgufGVufDB8fDB8fHww"
            ...
            <div className="relative flex flex-col justify-center p-10 md:p-16">
              <div
                ...
                style={{
                  background:
                    "radial-gradient(ellipse 80% 80% at 80% 50%, rgba(34,197,94,0.07), transparent)",
                }}
              />
              <div className="relative z-10">
                ...
                >
                  Apply for a wholesale account and get access to 200+ premium
                  brands at distributor pricing.
                </p>
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <Link href="/catalogue" className="btn-ghost px-7 py-3.5">
                    Browse Catalogue
                  </Link>
                </div>
              </div>
